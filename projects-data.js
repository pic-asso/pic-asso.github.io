...
async def cmd_lesson(update, context):
    ...
    tos: [
      ...
      },
      {
        ...
        text: 'Lesson content is generated by Anthropic\'s Claude model. While quality is generally high, AI can make mistakes. HablaIA is a learning aid — always verify important language questions with a native speaker or authoritative reference.',
      },
      {
        title: 'Data & Privacy',
